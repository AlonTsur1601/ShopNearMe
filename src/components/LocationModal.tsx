...
function Recenter({ place }: { place: Place }) { const map = useMap(); useEffect(() => { map.setView([place.lat, place.lon], 13); }, [map, place]); return null; }
