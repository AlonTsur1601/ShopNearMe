...
async function rate(from, to) {
  ...
  try {
    const response = await budgetFetch("https://api.frankfurter.dev/v2/rate/" + encodeURIComponent(from) + "/" + encodeURIComponent(to) + "?providers=ECB", { signal: controller.signal });
